 ...
 * @param profile the profile attributes to update
 * @param callback
 */
OomnitzaNode.prototype.editUser = function(uid, profile, callback) {
    ...
    var sb = new StringBuilder("&");
    for(prop in profile) sb.append("output[" + prop.toUpperCase() + "]=" + profile[prop]);
    this.request.post("people/individuals/edit", sb.toString(), {id: uid}, callback);
}
...
OomnitzaNode.prototype.findLocation = function() {
    // TODO Oomnitza does not have any documentation in this respect
